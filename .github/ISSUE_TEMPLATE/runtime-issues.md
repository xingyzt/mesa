...
1. Have you searched the [existing issues](https://github.com/MESAHub/mesa/issues?q=is%3Aissue) (open *and* closed) for
   similar issues?
...
Describe what kind of star (or binary) you're trying to model. What version of MESA are you using? Where did you get
your basic inlist from? What changes did you make?

**What did you expect to happen?**
Describe what results you expected MESA to produce.

**What happened instead?**
Describe what MESA output you got instead. Include any plots you made to try and diagnose what went wrong. Also include
any warnings or error messages MESA produced.
