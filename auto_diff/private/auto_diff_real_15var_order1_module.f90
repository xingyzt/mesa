module auto_diff_real_15var_order1_module
   ...
   interface differentiate_1
      module procedure differentiate_auto_diff_real_15var_order1_1
   end interface differentiate_1
   
   interface differentiate_2
      module procedure differentiate_auto_diff_real_15var_order1_2
   end interface differentiate_2
   
   interface differentiate_3
      module procedure differentiate_auto_diff_real_15var_order1_3
   end interface differentiate_3
   
   interface differentiate_4
      module procedure differentiate_auto_diff_real_15var_order1_4
   end interface differentiate_4
   
   interface differentiate_5
      module procedure differentiate_auto_diff_real_15var_order1_5
   end interface differentiate_5
   
   interface differentiate_6
      module procedure differentiate_auto_diff_real_15var_order1_6
   end interface differentiate_6
   
   interface differentiate_7
      module procedure differentiate_auto_diff_real_15var_order1_7
   end interface differentiate_7
   
   interface differentiate_8
      module procedure differentiate_auto_diff_real_15var_order1_8
   end interface differentiate_8
   
   interface differentiate_9
      module procedure differentiate_auto_diff_real_15var_order1_9
   end interface differentiate_9
   
   interface differentiate_10
      module procedure differentiate_auto_diff_real_15var_order1_10
   end interface differentiate_10
   
   interface differentiate_11
      module procedure differentiate_auto_diff_real_15var_order1_11
   end interface differentiate_11
   
   interface differentiate_12
      module procedure differentiate_auto_diff_real_15var_order1_12
   end interface differentiate_12
   
   interface differentiate_13
      module procedure differentiate_auto_diff_real_15var_order1_13
   end interface differentiate_13
   
   interface differentiate_14
      module procedure differentiate_auto_diff_real_15var_order1_14
   end interface differentiate_14
   
   interface differentiate_15
      module procedure differentiate_auto_diff_real_15var_order1_15
   end interface differentiate_15
...
contains
   ...
   subroutine assign_from_self(this, other)
      ...
      this%d1val4 = other%d1val4
      this%d1val5 = other%d1val5
      this%d1val6 = other%d1val6
      this%d1val7 = other%d1val7
      this%d1val8 = other%d1val8
      this%d1val9 = other%d1val9
      this%d1val10 = other%d1val10
      this%d1val11 = other%d1val11
      this%d1val12 = other%d1val12
      this%d1val13 = other%d1val13
      this%d1val14 = other%d1val14
      this%d1val15 = other%d1val15
   ...
   function make_unary_operator(x, z_val, z_d1x) result(unary)
      ...
      unary%d1val4 = x%d1val4*z_d1x
      unary%d1val5 = x%d1val5*z_d1x
      unary%d1val6 = x%d1val6*z_d1x
      unary%d1val7 = x%d1val7*z_d1x
      unary%d1val8 = x%d1val8*z_d1x
      unary%d1val9 = x%d1val9*z_d1x
      unary%d1val10 = x%d1val10*z_d1x
      unary%d1val11 = x%d1val11*z_d1x
      unary%d1val12 = x%d1val12*z_d1x
      unary%d1val13 = x%d1val13*z_d1x
      unary%d1val14 = x%d1val14*z_d1x
      unary%d1val15 = x%d1val15*z_d1x
   ...
   function make_binary_operator(x, y, z_val, z_d1x, z_d1y) result(binary)
      ...
      binary%d1val5 = x%d1val5*z_d1x + y%d1val5*z_d1y
      binary%d1val6 = x%d1val6*z_d1x + y%d1val6*z_d1y
      binary%d1val7 = x%d1val7*z_d1x + y%d1val7*z_d1y
      binary%d1val8 = x%d1val8*z_d1x + y%d1val8*z_d1y
      binary%d1val9 = x%d1val9*z_d1x + y%d1val9*z_d1y
      binary%d1val10 = x%d1val10*z_d1x + y%d1val10*z_d1y
      binary%d1val11 = x%d1val11*z_d1x + y%d1val11*z_d1y
      binary%d1val12 = x%d1val12*z_d1x + y%d1val12*z_d1y
      binary%d1val13 = x%d1val13*z_d1x + y%d1val13*z_d1y
      binary%d1val14 = x%d1val14*z_d1x + y%d1val14*z_d1y
      binary%d1val15 = x%d1val15*z_d1x + y%d1val15*z_d1y
   ...
   function sign_self(x) result(unary)
      ...
      unary%d1val8 = 0.0_dp
      unary%d1val9 = 0.0_dp
      unary%d1val10 = 0.0_dp
      unary%d1val11 = 0.0_dp
      unary%d1val12 = 0.0_dp
      unary%d1val13 = 0.0_dp
      unary%d1val14 = 0.0_dp
      unary%d1val15 = 0.0_dp
   ...
   function safe_sqrt_self(x) result(unary)
      ...
      real(dp) :: q1
      real(dp) :: q0
      q0 = sqrt(x%val*Heaviside(x%val, 0.5_dp))
      ...
      unary%d1val5 = q1*x%d1val5
      unary%d1val6 = q1*x%d1val6
      unary%d1val7 = q1*x%d1val7
      unary%d1val8 = q1*x%d1val8
      unary%d1val9 = q1*x%d1val9
      unary%d1val10 = q1*x%d1val10
      unary%d1val11 = q1*x%d1val11
      unary%d1val12 = q1*x%d1val12
      unary%d1val13 = q1*x%d1val13
      unary%d1val14 = q1*x%d1val14
      unary%d1val15 = q1*x%d1val15
   ...
   function unary_minus_self(x) result(unary)
      ...
      unary%d1val4 = -x%d1val4
      unary%d1val5 = -x%d1val5
      unary%d1val6 = -x%d1val6
      unary%d1val7 = -x%d1val7
      unary%d1val8 = -x%d1val8
      unary%d1val9 = -x%d1val9
      unary%d1val10 = -x%d1val10
      unary%d1val11 = -x%d1val11
      unary%d1val12 = -x%d1val12
      unary%d1val13 = -x%d1val13
      unary%d1val14 = -x%d1val14
      unary%d1val15 = -x%d1val15
   ...
   function exp_self(x) result(unary)
      ...
      unary%d1val5 = q0*x%d1val5
      unary%d1val6 = q0*x%d1val6
      unary%d1val7 = q0*x%d1val7
      unary%d1val8 = q0*x%d1val8
      unary%d1val9 = q0*x%d1val9
      unary%d1val10 = q0*x%d1val10
      unary%d1val11 = q0*x%d1val11
      unary%d1val12 = q0*x%d1val12
      unary%d1val13 = q0*x%d1val13
      unary%d1val14 = q0*x%d1val14
      unary%d1val15 = q0*x%d1val15
   ...
   function add_self(x, y) result(binary)
      ...
      binary%d1val4 = x%d1val4 + y%d1val4
      binary%d1val5 = x%d1val5 + y%d1val5
      binary%d1val6 = x%d1val6 + y%d1val6
      binary%d1val7 = x%d1val7 + y%d1val7
      binary%d1val8 = x%d1val8 + y%d1val8
      binary%d1val9 = x%d1val9 + y%d1val9
      binary%d1val10 = x%d1val10 + y%d1val10
      binary%d1val11 = x%d1val11 + y%d1val11
      binary%d1val12 = x%d1val12 + y%d1val12
      binary%d1val13 = x%d1val13 + y%d1val13
      binary%d1val14 = x%d1val14 + y%d1val14
      binary%d1val15 = x%d1val15 + y%d1val15
   ...
   function mul_self(x, y) result(binary)
      ...
      binary%d1val4 = x%d1val4*y%val + x%val*y%d1val4
      binary%d1val5 = x%d1val5*y%val + x%val*y%d1val5
      binary%d1val6 = x%d1val6*y%val + x%val*y%d1val6
      binary%d1val7 = x%d1val7*y%val + x%val*y%d1val7
      binary%d1val8 = x%d1val8*y%val + x%val*y%d1val8
      binary%d1val9 = x%d1val9*y%val + x%val*y%d1val9
      binary%d1val10 = x%d1val10*y%val + x%val*y%d1val10
      binary%d1val11 = x%d1val11*y%val + x%val*y%d1val11
      binary%d1val12 = x%d1val12*y%val + x%val*y%d1val12
      binary%d1val13 = x%d1val13*y%val + x%val*y%d1val13
      binary%d1val14 = x%d1val14*y%val + x%val*y%d1val14
      binary%d1val15 = x%d1val15*y%val + x%val*y%d1val15
   ...
   function mul_self_real(x, y) result(unary)
      ...
      unary%d1val4 = x%d1val4*y
      unary%d1val5 = x%d1val5*y
      unary%d1val6 = x%d1val6*y
      unary%d1val7 = x%d1val7*y
      unary%d1val8 = x%d1val8*y
      unary%d1val9 = x%d1val9*y
      unary%d1val10 = x%d1val10*y
      unary%d1val11 = x%d1val11*y
      unary%d1val12 = x%d1val12*y
      unary%d1val13 = x%d1val13*y
      unary%d1val14 = x%d1val14*y
      unary%d1val15 = x%d1val15*y
   ...
   function mul_real_self(z, x) result(unary)
      ...
      unary%d1val4 = x%d1val4*z
      unary%d1val5 = x%d1val5*z
      unary%d1val6 = x%d1val6*z
      unary%d1val7 = x%d1val7*z
      unary%d1val8 = x%d1val8*z
      unary%d1val9 = x%d1val9*z
      unary%d1val10 = x%d1val10*z
      unary%d1val11 = x%d1val11*z
      unary%d1val12 = x%d1val12*z
      unary%d1val13 = x%d1val13*z
      unary%d1val14 = x%d1val14*z
      unary%d1val15 = x%d1val15*z
   ...
   function mul_self_int(x, y) result(unary)
      ...
      unary%d1val4 = x%d1val4*y_dp
      unary%d1val5 = x%d1val5*y_dp
      unary%d1val6 = x%d1val6*y_dp
      unary%d1val7 = x%d1val7*y_dp
      unary%d1val8 = x%d1val8*y_dp
      unary%d1val9 = x%d1val9*y_dp
      unary%d1val10 = x%d1val10*y_dp
      unary%d1val11 = x%d1val11*y_dp
      unary%d1val12 = x%d1val12*y_dp
      unary%d1val13 = x%d1val13*y_dp
      unary%d1val14 = x%d1val14*y_dp
      unary%d1val15 = x%d1val15*y_dp
   ...
   function div_self(x, y) result(binary)
      ...
      binary%d1val1 = q0*(x%d1val1*y%val - x%val*y%d1val1)
      binary%d1val2 = q0*(x%d1val2*y%val - x%val*y%d1val2)
      binary%d1val3 = q0*(x%d1val3*y%val - x%val*y%d1val3)
      binary%d1val4 = q0*(x%d1val4*y%val - x%val*y%d1val4)
      binary%d1val5 = q0*(x%d1val5*y%val - x%val*y%d1val5)
      binary%d1val6 = q0*(x%d1val6*y%val - x%val*y%d1val6)
      binary%d1val7 = q0*(x%d1val7*y%val - x%val*y%d1val7)
      binary%d1val8 = q0*(x%d1val8*y%val - x%val*y%d1val8)
      binary%d1val9 = q0*(x%d1val9*y%val - x%val*y%d1val9)
      binary%d1val10 = q0*(x%d1val10*y%val - x%val*y%d1val10)
      binary%d1val11 = q0*(x%d1val11*y%val - x%val*y%d1val11)
      binary%d1val12 = q0*(x%d1val12*y%val - x%val*y%d1val12)
      binary%d1val13 = q0*(x%d1val13*y%val - x%val*y%d1val13)
      binary%d1val14 = q0*(x%d1val14*y%val - x%val*y%d1val14)
      binary%d1val15 = q0*(x%d1val15*y%val - x%val*y%d1val15)
   ...
   function pow_self(x, y) result(binary)
      ...
      binary%d1val1 = q0*(q1*y%d1val1 + x%d1val1*y%val)
      binary%d1val2 = q0*(q1*y%d1val2 + x%d1val2*y%val)
      binary%d1val3 = q0*(q1*y%d1val3 + x%d1val3*y%val)
      binary%d1val4 = q0*(q1*y%d1val4 + x%d1val4*y%val)
      binary%d1val5 = q0*(q1*y%d1val5 + x%d1val5*y%val)
      binary%d1val6 = q0*(q1*y%d1val6 + x%d1val6*y%val)
      binary%d1val7 = q0*(q1*y%d1val7 + x%d1val7*y%val)
      binary%d1val8 = q0*(q1*y%d1val8 + x%d1val8*y%val)
      binary%d1val9 = q0*(q1*y%d1val9 + x%d1val9*y%val)
      binary%d1val10 = q0*(q1*y%d1val10 + x%d1val10*y%val)
      binary%d1val11 = q0*(q1*y%d1val11 + x%d1val11*y%val)
      binary%d1val12 = q0*(q1*y%d1val12 + x%d1val12*y%val)
      binary%d1val13 = q0*(q1*y%d1val13 + x%d1val13*y%val)
      binary%d1val14 = q0*(q1*y%d1val14 + x%d1val14*y%val)
      binary%d1val15 = q0*(q1*y%d1val15 + x%d1val15*y%val)
   ...
   function max_self(x, y) result(binary)
      ...
      real(dp) :: q0
      q0 = x%val - y%val
      q1 = Heaviside(q0, 0.5_dp)
      q2 = Heaviside(-q0, 0.5_dp)
      binary%val = Max(x%val, y%val)
      binary%d1val1 = q1*x%d1val1 + q2*y%d1val1
      binary%d1val2 = q1*x%d1val2 + q2*y%d1val2
      binary%d1val3 = q1*x%d1val3 + q2*y%d1val3
      binary%d1val4 = q1*x%d1val4 + q2*y%d1val4
      binary%d1val5 = q1*x%d1val5 + q2*y%d1val5
      binary%d1val6 = q1*x%d1val6 + q2*y%d1val6
      binary%d1val7 = q1*x%d1val7 + q2*y%d1val7
      binary%d1val8 = q1*x%d1val8 + q2*y%d1val8
      binary%d1val9 = q1*x%d1val9 + q2*y%d1val9
      binary%d1val10 = q1*x%d1val10 + q2*y%d1val10
      binary%d1val11 = q1*x%d1val11 + q2*y%d1val11
      binary%d1val12 = q1*x%d1val12 + q2*y%d1val12
      binary%d1val13 = q1*x%d1val13 + q2*y%d1val13
      binary%d1val14 = q1*x%d1val14 + q2*y%d1val14
      binary%d1val15 = q1*x%d1val15 + q2*y%d1val15
   ...
   function max_self_int(x, y) result(unary)
      ...
      real(dp) :: q0
      y_dp = y
      q0 = Heaviside(x%val - y_dp, 0.5_dp)
   ...
   function dim_self(x, y) result(binary)
      ...
      binary%d1val3 = -0.5_dp*y%d1val3 + 0.5_dp*x%d1val3 + q1*(x%d1val3 - y%d1val3)
      binary%d1val4 = -0.5_dp*y%d1val4 + 0.5_dp*x%d1val4 + q1*(x%d1val4 - y%d1val4)
      binary%d1val5 = -0.5_dp*y%d1val5 + 0.5_dp*x%d1val5 + q1*(x%d1val5 - y%d1val5)
      binary%d1val6 = -0.5_dp*y%d1val6 + 0.5_dp*x%d1val6 + q1*(x%d1val6 - y%d1val6)
      binary%d1val7 = -0.5_dp*y%d1val7 + 0.5_dp*x%d1val7 + q1*(x%d1val7 - y%d1val7)
      binary%d1val8 = -0.5_dp*y%d1val8 + 0.5_dp*x%d1val8 + q1*(x%d1val8 - y%d1val8)
      binary%d1val9 = -0.5_dp*y%d1val9 + 0.5_dp*x%d1val9 + q1*(x%d1val9 - y%d1val9)
      binary%d1val10 = -0.5_dp*y%d1val10 + 0.5_dp*x%d1val10 + q1*(x%d1val10 - y%d1val10)
      binary%d1val11 = -0.5_dp*y%d1val11 + 0.5_dp*x%d1val11 + q1*(x%d1val11 - y%d1val11)
      binary%d1val12 = -0.5_dp*y%d1val12 + 0.5_dp*x%d1val12 + q1*(x%d1val12 - y%d1val12)
      binary%d1val13 = -0.5_dp*y%d1val13 + 0.5_dp*x%d1val13 + q1*(x%d1val13 - y%d1val13)
      binary%d1val14 = -0.5_dp*y%d1val14 + 0.5_dp*x%d1val14 + q1*(x%d1val14 - y%d1val14)
      binary%d1val15 = -0.5_dp*y%d1val15 + 0.5_dp*x%d1val15 + q1*(x%d1val15 - y%d1val15)
   ...
   function differentiate_auto_diff_real_15var_order1_1(this) result(derivative)
      type(auto_diff_real_15var_order1), intent(in) :: this
      type(auto_diff_real_15var_order1) :: derivative
      derivative%val = this%d1val1
      derivative%d1val1 = 0_dp
      derivative%d1val2 = 0_dp
      derivative%d1val3 = 0_dp
      derivative%d1val4 = 0_dp
      derivative%d1val5 = 0_dp
      derivative%d1val6 = 0_dp
      derivative%d1val7 = 0_dp
      derivative%d1val8 = 0_dp
      derivative%d1val9 = 0_dp
      derivative%d1val10 = 0_dp
      derivative%d1val11 = 0_dp
      derivative%d1val12 = 0_dp
      derivative%d1val13 = 0_dp
      derivative%d1val14 = 0_dp
      derivative%d1val15 = 0_dp
   end function differentiate_auto_diff_real_15var_order1_1
   
   function differentiate_auto_diff_real_15var_order1_2(this) result(derivative)
      type(auto_diff_real_15var_order1), intent(in) :: this
      type(auto_diff_real_15var_order1) :: derivative
      ...
      derivative%d1val14 = 0_dp
      derivative%d1val15 = 0_dp
   end function differentiate_auto_diff_real_15var_order1_2
   
   function differentiate_auto_diff_real_15var_order1_3(this) result(derivative)
      type(auto_diff_real_15var_order1), intent(in) :: this
      type(auto_diff_real_15var_order1) :: derivative
      ...
      derivative%d1val14 = 0_dp
      derivative%d1val15 = 0_dp
   end function differentiate_auto_diff_real_15var_order1_3
   
   function differentiate_auto_diff_real_15var_order1_4(this) result(derivative)
      type(auto_diff_real_15var_order1), intent(in) :: this
      type(auto_diff_real_15var_order1) :: derivative
      ...
      derivative%d1val14 = 0_dp
      derivative%d1val15 = 0_dp
   end function differentiate_auto_diff_real_15var_order1_4
   
   function differentiate_auto_diff_real_15var_order1_5(this) result(derivative)
      type(auto_diff_real_15var_order1), intent(in) :: this
      type(auto_diff_real_15var_order1) :: derivative
      derivative%val = this%d1val5
      derivative%d1val1 = 0_dp
      derivative%d1val2 = 0_dp
      derivative%d1val3 = 0_dp
      derivative%d1val4 = 0_dp
      ...
      derivative%d1val14 = 0_dp
      derivative%d1val15 = 0_dp
   end function differentiate_auto_diff_real_15var_order1_5
   
   function differentiate_auto_diff_real_15var_order1_6(this) result(derivative)
      type(auto_diff_real_15var_order1), intent(in) :: this
      type(auto_diff_real_15var_order1) :: derivative
      derivative%val = this%d1val6
      derivative%d1val1 = 0_dp
      derivative%d1val2 = 0_dp
      derivative%d1val3 = 0_dp
      derivative%d1val4 = 0_dp
      ...
      derivative%d1val14 = 0_dp
      derivative%d1val15 = 0_dp
   end function differentiate_auto_diff_real_15var_order1_6
   
   function differentiate_auto_diff_real_15var_order1_7(this) result(derivative)
      type(auto_diff_real_15var_order1), intent(in) :: this
      type(auto_diff_real_15var_order1) :: derivative
      derivative%val = this%d1val7
      derivative%d1val1 = 0_dp
      derivative%d1val2 = 0_dp
      derivative%d1val3 = 0_dp
      derivative%d1val4 = 0_dp
      ...
      derivative%d1val14 = 0_dp
      derivative%d1val15 = 0_dp
   end function differentiate_auto_diff_real_15var_order1_7
   
   function differentiate_auto_diff_real_15var_order1_8(this) result(derivative)
      type(auto_diff_real_15var_order1), intent(in) :: this
      type(auto_diff_real_15var_order1) :: derivative
      derivative%val = this%d1val8
      derivative%d1val1 = 0_dp
      derivative%d1val2 = 0_dp
      derivative%d1val3 = 0_dp
      derivative%d1val4 = 0_dp
      ...
      derivative%d1val14 = 0_dp
      derivative%d1val15 = 0_dp
   end function differentiate_auto_diff_real_15var_order1_8
   
   function differentiate_auto_diff_real_15var_order1_9(this) result(derivative)
      type(auto_diff_real_15var_order1), intent(in) :: this
      type(auto_diff_real_15var_order1) :: derivative
      derivative%val = this%d1val9
      derivative%d1val1 = 0_dp
      derivative%d1val2 = 0_dp
      derivative%d1val3 = 0_dp
      derivative%d1val4 = 0_dp
      ...
      derivative%d1val14 = 0_dp
      derivative%d1val15 = 0_dp
   end function differentiate_auto_diff_real_15var_order1_9
   
   function differentiate_auto_diff_real_15var_order1_10(this) result(derivative)
      type(auto_diff_real_15var_order1), intent(in) :: this
      type(auto_diff_real_15var_order1) :: derivative
      derivative%val = this%d1val10
      derivative%d1val1 = 0_dp
      derivative%d1val2 = 0_dp
      derivative%d1val3 = 0_dp
      derivative%d1val4 = 0_dp
      ...
      derivative%d1val14 = 0_dp
      derivative%d1val15 = 0_dp
   end function differentiate_auto_diff_real_15var_order1_10
   
   function differentiate_auto_diff_real_15var_order1_11(this) result(derivative)
      type(auto_diff_real_15var_order1), intent(in) :: this
      type(auto_diff_real_15var_order1) :: derivative
      derivative%val = this%d1val11
      derivative%d1val1 = 0_dp
      derivative%d1val2 = 0_dp
      derivative%d1val3 = 0_dp
      derivative%d1val4 = 0_dp
      ...
      derivative%d1val14 = 0_dp
      derivative%d1val15 = 0_dp
   end function differentiate_auto_diff_real_15var_order1_11
   
   function differentiate_auto_diff_real_15var_order1_12(this) result(derivative)
      type(auto_diff_real_15var_order1), intent(in) :: this
      type(auto_diff_real_15var_order1) :: derivative
      derivative%val = this%d1val12
      derivative%d1val1 = 0_dp
      derivative%d1val2 = 0_dp
      derivative%d1val3 = 0_dp
      derivative%d1val4 = 0_dp
      ...
      derivative%d1val14 = 0_dp
      derivative%d1val15 = 0_dp
   end function differentiate_auto_diff_real_15var_order1_12
   
   function differentiate_auto_diff_real_15var_order1_13(this) result(derivative)
      type(auto_diff_real_15var_order1), intent(in) :: this
      type(auto_diff_real_15var_order1) :: derivative
      derivative%val = this%d1val13
      derivative%d1val1 = 0_dp
      derivative%d1val2 = 0_dp
      derivative%d1val3 = 0_dp
      derivative%d1val4 = 0_dp
      ...
      derivative%d1val14 = 0_dp
      derivative%d1val15 = 0_dp
   end function differentiate_auto_diff_real_15var_order1_13
   
   function differentiate_auto_diff_real_15var_order1_14(this) result(derivative)
      type(auto_diff_real_15var_order1), intent(in) :: this
      type(auto_diff_real_15var_order1) :: derivative
      derivative%val = this%d1val14
      derivative%d1val1 = 0_dp
      derivative%d1val2 = 0_dp
      derivative%d1val3 = 0_dp
      derivative%d1val4 = 0_dp
      ...
      derivative%d1val14 = 0_dp
      derivative%d1val15 = 0_dp
   end function differentiate_auto_diff_real_15var_order1_14
   
   function differentiate_auto_diff_real_15var_order1_15(this) result(derivative)
      type(auto_diff_real_15var_order1), intent(in) :: this
      type(auto_diff_real_15var_order1) :: derivative
      derivative%val = this%d1val15
      derivative%d1val1 = 0_dp
      derivative%d1val2 = 0_dp
      derivative%d1val3 = 0_dp
      derivative%d1val4 = 0_dp
      ...
      derivative%d1val14 = 0_dp
      derivative%d1val15 = 0_dp
   end function differentiate_auto_diff_real_15var_order1_15
