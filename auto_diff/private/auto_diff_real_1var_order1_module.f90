...
contains
   ...
   function max_self(x, y) result(binary)
      ...
      binary%d1val1 = x%d1val1 * Heaviside(x%val - y%val) + y%d1val1 * Heaviside(-x%val + y%val)
   ...
   function max_self_real(x, y) result(unary)
      ...
      unary%d1val1 = x%d1val1 * Heaviside(x%val - y)
   ...
   function max_real_self(z, x) result(unary)
      ...
      unary%d1val1 = x%d1val1 * Heaviside(x%val - z)
   ...
   function max_self_int(x, y) result(unary)
      ...
      unary%d1val1 = x%d1val1 * Heaviside(x%val - y_dp)
