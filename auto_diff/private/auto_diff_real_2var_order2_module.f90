...
contains
   ...
   function safe_sqrt_self(x) result(unary)
      ...
      q2 = 0.25_dp*q0*powm1(pow2(x%val))
      unary%val = q0
      unary%d1val1 = q1*x%d1val1
      unary%d1val2 = q1*x%d1val2
      unary%d2val1 = q2*(2.0_dp*x%d2val1*x%val - pow2(x%d1val1))
      unary%d1val1_d1val2 = q2*(2.0_dp*x%d1val1_d1val2*x%val - x%d1val1*x%d1val2)
      unary%d2val2 = q2*(2.0_dp*x%d2val2*x%val - pow2(x%d1val2))
   ...
   function asin_self(x) result(unary)
      ...
      unary%d1val1 = q2*x%d1val1
      unary%d1val2 = q2*x%d1val2
      unary%d2val1 = q3*(-q0*x%d2val1 + x%val*pow2(x%d1val1))
      unary%d1val1_d1val2 = q3*(q1*x%d1val1_d1val2 + x%d1val1*x%d1val2*x%val)
      unary%d2val2 = q3*(-q0*x%d2val2 + x%val*pow2(x%d1val2))
   ...
   function asinpi_self(x) result(unary)
      ...
      q2 = -q1
      q3 = q0*powm1(sqrt(q2))
      q4 = q0*powm1(pow3(sqrt(q2)))
      unary%val = q0*asin(x%val)
      unary%d1val1 = q3*x%d1val1
      unary%d1val2 = q3*x%d1val2
      unary%d2val1 = q4*(-q1*x%d2val1 + x%val*pow2(x%d1val1))
      unary%d1val1_d1val2 = q4*(q2*x%d1val1_d1val2 + x%d1val1*x%d1val2*x%val)
      unary%d2val2 = q4*(-q1*x%d2val2 + x%val*pow2(x%d1val2))
   ...
   function atanpi_self(x) result(unary)
      ...
      q2 = powm1(pi + q1)
      q3 = 2.0_dp*x%val
      q4 = powm1(2.0_dp*q1 + pi*pow4(x%val) + pi)
      unary%val = powm1(pi)*atan(x%val)
      unary%d1val1 = q2*x%d1val1
      unary%d1val2 = q2*x%d1val2
      unary%d2val1 = q4*(q0*x%d2val1 - q3*pow2(x%d1val1) + x%d2val1)
   ...
   function acosh_self(x) result(unary)
      ...
      unary%d1val1 = q0*x%d1val1
      unary%d1val2 = q0*x%d1val2
      unary%d2val1 = q2*(q1*x%d2val1 - x%d2val1 - x%val*pow2(x%d1val1))
      unary%d1val1_d1val2 = q2*(q1*x%d1val1_d1val2 - x%d1val1*x%d1val2*x%val - x%d1val1_d1val2)
      unary%d2val2 = q2*(q1*x%d2val2 - x%d2val2 - x%val*pow2(x%d1val2))
   ...
   function sqrt_self(x) result(unary)
      ...
      q0 = sqrt(x%val)
      q1 = 0.5_dp*powm1(q0)
      q2 = 0.25_dp*powm1(pow3(sqrt(x%val)))
      unary%val = q0
      unary%d1val1 = q1*x%d1val1
      unary%d1val2 = q1*x%d1val2
      unary%d2val1 = q2*(2.0_dp*x%d2val1*x%val - pow2(x%d1val1))
   ...
   function div_self(x, y) result(binary)
      ...
      binary%d1val2 = q1*(q4 - x%val*y%d1val2)
      binary%d2val1 = q5*(-2.0_dp*q2*y%d1val1 + q0*x%d2val1 + x%val*(2.0_dp*pow2(y%d1val1) - y%d2val1*y%val))
   ...
   function pow_self(x, y) result(binary)
      ...
      q3 = q2*x%val
      q4 = q1 + q3*y%d1val1
      q5 = q3*y%d1val2 + x%d1val2*y%val
      q6 = pow(x%val, -2.0_dp + y%val)
      q7 = q2*pow2(x%val)
