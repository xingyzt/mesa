module auto_diff_real_4var_order1_module
   ...
   implicit none
   private
   public :: auto_diff_real_4var_order1, &
      assignment(=), &
      operator(.eq.), &
      operator(.ne.), &
      operator(.gt.), &
   ...
   type :: auto_diff_real_4var_order1
      ...
      real(dp) :: d1val3
      real(dp) :: d1val4
   end type auto_diff_real_4var_order1
   ...
   interface operator(.eq.)
      ...
      module procedure equal_auto_diff_real_4var_order1_real_dp
      module procedure equal_real_dp_auto_diff_real_4var_order1
      module procedure equal_auto_diff_real_4var_order1_int
      module procedure equal_int_auto_diff_real_4var_order1
   end interface operator(.eq.)
   
   interface operator(.ne.)
      module procedure neq_self
      module procedure neq_auto_diff_real_4var_order1_real_dp
      module procedure neq_real_dp_auto_diff_real_4var_order1
      module procedure neq_auto_diff_real_4var_order1_int
      module procedure neq_int_auto_diff_real_4var_order1
   end interface operator(.ne.)
   
   interface operator(.gt.)
      module procedure greater_self
      module procedure greater_auto_diff_real_4var_order1_real_dp
      module procedure greater_real_dp_auto_diff_real_4var_order1
      module procedure greater_auto_diff_real_4var_order1_int
      module procedure greater_int_auto_diff_real_4var_order1
   end interface operator(.gt.)
   
   interface operator(.lt.)
      module procedure less_self
      module procedure less_auto_diff_real_4var_order1_real_dp
      module procedure less_real_dp_auto_diff_real_4var_order1
      module procedure less_auto_diff_real_4var_order1_int
      module procedure less_int_auto_diff_real_4var_order1
   end interface operator(.lt.)
   
   interface operator(.le.)
      module procedure leq_self
      module procedure leq_auto_diff_real_4var_order1_real_dp
      module procedure leq_real_dp_auto_diff_real_4var_order1
      module procedure leq_auto_diff_real_4var_order1_int
      module procedure leq_int_auto_diff_real_4var_order1
   end interface operator(.le.)
   
   interface operator(.ge.)
      module procedure geq_self
      module procedure geq_auto_diff_real_4var_order1_real_dp
      module procedure geq_real_dp_auto_diff_real_4var_order1
      module procedure geq_auto_diff_real_4var_order1_int
      module procedure geq_int_auto_diff_real_4var_order1
   ...
   interface differentiate_1
      module procedure differentiate_auto_diff_real_4var_order1_1
   end interface differentiate_1
   
   interface differentiate_2
      module procedure differentiate_auto_diff_real_4var_order1_2
   end interface differentiate_2
   
   interface differentiate_3
      module procedure differentiate_auto_diff_real_4var_order1_3
...
contains
   ...
   subroutine assign_from_self(this, other)
      ...
      type(auto_diff_real_4var_order1), intent(in) :: other
      this%val = other%val
   ...
   function equal_auto_diff_real_4var_order1_real_dp(this, other) result(z)
      type(auto_diff_real_4var_order1), intent(in) :: this
      real(dp), intent(in) :: other
      logical :: z
      z = (this%val .eq. other)
   end function equal_auto_diff_real_4var_order1_real_dp
   
   function equal_real_dp_auto_diff_real_4var_order1(this, other) result(z)
      real(dp), intent(in) :: this
      type(auto_diff_real_4var_order1), intent(in) :: other
      logical :: z
      z = (this .eq. other%val)
   end function equal_real_dp_auto_diff_real_4var_order1
   
   function equal_auto_diff_real_4var_order1_int(this, other) result(z)
      type(auto_diff_real_4var_order1), intent(in) :: this
      integer, intent(in) :: other
      logical :: z
      z = (this%val .eq. other)
   end function equal_auto_diff_real_4var_order1_int
   
   function equal_int_auto_diff_real_4var_order1(this, other) result(z)
      integer, intent(in) :: this
      type(auto_diff_real_4var_order1), intent(in) :: other
      logical :: z
      z = (this .eq. other%val)
   end function equal_int_auto_diff_real_4var_order1
   ...
   function neq_auto_diff_real_4var_order1_real_dp(this, other) result(z)
      type(auto_diff_real_4var_order1), intent(in) :: this
      real(dp), intent(in) :: other
      logical :: z
      z = (this%val .ne. other)
   end function neq_auto_diff_real_4var_order1_real_dp
   
   function neq_real_dp_auto_diff_real_4var_order1(this, other) result(z)
      real(dp), intent(in) :: this
      type(auto_diff_real_4var_order1), intent(in) :: other
      logical :: z
      z = (this .ne. other%val)
   end function neq_real_dp_auto_diff_real_4var_order1
   
   function neq_auto_diff_real_4var_order1_int(this, other) result(z)
      type(auto_diff_real_4var_order1), intent(in) :: this
      integer, intent(in) :: other
      logical :: z
      z = (this%val .ne. other)
   end function neq_auto_diff_real_4var_order1_int
   
   function neq_int_auto_diff_real_4var_order1(this, other) result(z)
      integer, intent(in) :: this
      type(auto_diff_real_4var_order1), intent(in) :: other
      logical :: z
      z = (this .ne. other%val)
   end function neq_int_auto_diff_real_4var_order1
   ...
   function greater_auto_diff_real_4var_order1_real_dp(this, other) result(z)
      type(auto_diff_real_4var_order1), intent(in) :: this
      real(dp), intent(in) :: other
      logical :: z
      z = (this%val .gt. other)
   end function greater_auto_diff_real_4var_order1_real_dp
   
   function greater_real_dp_auto_diff_real_4var_order1(this, other) result(z)
      real(dp), intent(in) :: this
      type(auto_diff_real_4var_order1), intent(in) :: other
      logical :: z
      z = (this .gt. other%val)
   end function greater_real_dp_auto_diff_real_4var_order1
   
   function greater_auto_diff_real_4var_order1_int(this, other) result(z)
      type(auto_diff_real_4var_order1), intent(in) :: this
      integer, intent(in) :: other
      logical :: z
      z = (this%val .gt. other)
   end function greater_auto_diff_real_4var_order1_int
   
   function greater_int_auto_diff_real_4var_order1(this, other) result(z)
      integer, intent(in) :: this
      type(auto_diff_real_4var_order1), intent(in) :: other
      logical :: z
      z = (this .gt. other%val)
   end function greater_int_auto_diff_real_4var_order1
   ...
   function less_auto_diff_real_4var_order1_real_dp(this, other) result(z)
      type(auto_diff_real_4var_order1), intent(in) :: this
      real(dp), intent(in) :: other
      logical :: z
      z = (this%val .lt. other)
   end function less_auto_diff_real_4var_order1_real_dp
   
   function less_real_dp_auto_diff_real_4var_order1(this, other) result(z)
      real(dp), intent(in) :: this
      type(auto_diff_real_4var_order1), intent(in) :: other
      logical :: z
      z = (this .lt. other%val)
   end function less_real_dp_auto_diff_real_4var_order1
   
   function less_auto_diff_real_4var_order1_int(this, other) result(z)
      type(auto_diff_real_4var_order1), intent(in) :: this
      integer, intent(in) :: other
      logical :: z
      z = (this%val .lt. other)
   end function less_auto_diff_real_4var_order1_int
   
   function less_int_auto_diff_real_4var_order1(this, other) result(z)
      integer, intent(in) :: this
      type(auto_diff_real_4var_order1), intent(in) :: other
      logical :: z
      z = (this .lt. other%val)
   end function less_int_auto_diff_real_4var_order1
   ...
   function leq_auto_diff_real_4var_order1_real_dp(this, other) result(z)
      type(auto_diff_real_4var_order1), intent(in) :: this
      real(dp), intent(in) :: other
      logical :: z
      z = (this%val .le. other)
   end function leq_auto_diff_real_4var_order1_real_dp
   
   function leq_real_dp_auto_diff_real_4var_order1(this, other) result(z)
      real(dp), intent(in) :: this
      type(auto_diff_real_4var_order1), intent(in) :: other
      logical :: z
      z = (this .le. other%val)
   end function leq_real_dp_auto_diff_real_4var_order1
   
   function leq_auto_diff_real_4var_order1_int(this, other) result(z)
      type(auto_diff_real_4var_order1), intent(in) :: this
      integer, intent(in) :: other
      logical :: z
      z = (this%val .le. other)
   end function leq_auto_diff_real_4var_order1_int
   
   function leq_int_auto_diff_real_4var_order1(this, other) result(z)
      integer, intent(in) :: this
      type(auto_diff_real_4var_order1), intent(in) :: other
      logical :: z
      z = (this .le. other%val)
   end function leq_int_auto_diff_real_4var_order1
   ...
   function geq_auto_diff_real_4var_order1_real_dp(this, other) result(z)
      type(auto_diff_real_4var_order1), intent(in) :: this
      real(dp), intent(in) :: other
      logical :: z
      z = (this%val .ge. other)
   end function geq_auto_diff_real_4var_order1_real_dp
   
   function geq_real_dp_auto_diff_real_4var_order1(this, other) result(z)
      real(dp), intent(in) :: this
      type(auto_diff_real_4var_order1), intent(in) :: other
      logical :: z
      z = (this .ge. other%val)
   end function geq_real_dp_auto_diff_real_4var_order1
   
   function geq_auto_diff_real_4var_order1_int(this, other) result(z)
      type(auto_diff_real_4var_order1), intent(in) :: this
      integer, intent(in) :: other
      logical :: z
      z = (this%val .ge. other)
   end function geq_auto_diff_real_4var_order1_int
   
   function geq_int_auto_diff_real_4var_order1(this, other) result(z)
      integer, intent(in) :: this
      type(auto_diff_real_4var_order1), intent(in) :: other
      logical :: z
      z = (this .ge. other%val)
   end function geq_int_auto_diff_real_4var_order1
   ...
   function make_binary_operator(x, y, z_val, z_d1x, z_d1y) result(binary)
      type(auto_diff_real_4var_order1), intent(in) :: x
      type(auto_diff_real_4var_order1), intent(in) :: y
      real(dp), intent(in) :: z_val
      real(dp), intent(in) :: z_d1x
      real(dp), intent(in) :: z_d1y
      type(auto_diff_real_4var_order1) :: binary
      binary%val = z_val
