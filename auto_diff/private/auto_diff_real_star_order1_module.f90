...
contains
   ...
   function acosh_self(x) result(unary)
      ...
      unary%d1Array(1:33) = x%d1Array(1:33)*powm1(sqrt(x%val - 1))*powm1(sqrt(x%val + 1))
   ...
   function max_self(x, y) result(binary)
      ...
      binary%d1Array(1:33) = x%d1Array(1:33)*Heaviside(q0, 0.5_dp) + y%d1Array(1:33)*Heaviside(-q0, 0.5_dp)
   ...
   function max_self_real(x, y) result(unary)
      ...
      unary%d1Array(1:33) = x%d1Array(1:33)*Heaviside(x%val - y, 0.5_dp)
   ...
   function max_real_self(z, x) result(unary)
      ...
      unary%d1Array(1:33) = x%d1Array(1:33)*Heaviside(x%val - z, 0.5_dp)
   ...
   function max_self_int(x, y) result(unary)
      ...
      unary%d1Array(1:33) = x%d1Array(1:33)*Heaviside(x%val - y_dp, 0.5_dp)
