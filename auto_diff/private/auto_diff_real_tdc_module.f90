...
contains
   ...
   function acosh_self(x) result(unary)
      ...
      unary%d1val1 = q0*x%d1val1
      unary%d1Array(1:33) = q0*x%d1Array(1:33)
      unary%d1val1_d1Array(1:33) = q0*(q1*x%d1val1_d1Array(1:33) - x%d1Array(1:33)*x%d1val1*x%val - x%d1val1_d1Array(1:33))*powm1(q1 - 1)
   ...
   function max_self(x, y) result(binary)
      ...
      binary%d1Array(1:33) = q1*x%d1Array(1:33) + q2*y%d1Array(1:33)
      binary%d1val1_d1Array(1:33) = q1*x%d1val1_d1Array(1:33) + q2*y%d1val1_d1Array(1:33)
