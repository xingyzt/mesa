...
parser.add_argument('-N', metavar='N', type=int, default=5,
                    help='The first N and last N photos by modified-time will be stashed.')
parser.add_argument('-m', metavar='m', type=str, default='', help='Notes about the experiment.')
parser.add_argument('--png', action='store_true',
                    help='Stash png files. If specified png files will be stashed and then removed from the working directory.')
